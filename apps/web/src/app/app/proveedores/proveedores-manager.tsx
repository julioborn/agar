...
interface Props { proveedores: ProveedorRow[]; empresaId: string; esLectorInsumos?: boolean }

export default function ProveedoresManager({ proveedores, empresaId, esLectorInsumos = false }: Props) {
